...
import ProjectEmpAssignAVED from './ProjectEmpAssignAVED'
  ...
  console.log(items);
    ...
    return (
              ...
              { showActionCol
                ? <Table.Cell>
                  {(allowView && props.listMode === "View") || props.listMode === "Edit"
                    ? <span> 
                        <ProjectEmpAssignAVED project={props.project} empAssignId={assignId} setMsgBar={props.setMsgBar} setReloadProjEmpAssignList={props.setReloadProjEmpAssignList} modalMode={"View"}/>&nbsp;&nbsp; 
                      </span>
                    :<></>  
                  }
                  {allowUp && props.listMode === "Edit"
                    ? <span> 
                       ...
                       <ProjectEmpAssignAVED project={props.project} empAssignId={assignId} setMsgBar={props.setMsgBar} setReloadProjEmpAssignList={props.setReloadProjEmpAssignList} modalMode={"Edit"}/>&nbsp;&nbsp; 
                      </span>
                    :<></>  
                  } 
                  {(allowDel && props.listMode === "Delete") || (allowDel && props.listMode === "Edit")
                    ? <span>
                        <ProjectEmpAssignAVED project={props.project} empAssignId={assignId} setMsgBar={props.setMsgBar} setReloadProjEmpAssignList={props.setReloadProjEmpAssignList} modalMode={"Delete"}/>
                      </span>
                    :<></>  
                  }
                  </Table.Cell>
      ...
      <Pagination
        ...
        ? <div> 
            <ProjectEmpAssignAVED project={props.project} setMsgBar={props.setMsgBar} setReloadProjEmpAssignList={props.setReloadProjEmpAssignList} modalMode={"Add"}/>&nbsp;&nbsp; 
          </div>
        :<></>
        }
