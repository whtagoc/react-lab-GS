...
const ProjectsTableListSemUI = props => {	
  ...
  console.log(items);
    ...
    return (
            ...
            <Table.Row key={projId}>
              ...
              { showActionCol
                ? <Table.Cell>
                  {allowView
                    ? <span> 
                        <Link to={`/ProjectAVEDTabsView/${projId}`}>View</Link>&nbsp;&nbsp;
                      </span>
                    :<></>  
                  }
                  {allowUp
                    ? <span> 
                        <Link to={`/ProjectAVEDTabs/${projId}`}>Edit</Link>&nbsp;&nbsp;
                      </span>
                    :<></>  
                  } 
                  {allowDel
                    ? <span>
						<Link to={`/ProjectAVEDTabsDelete/${projId}`}>Delete</Link>&nbsp;&nbsp;
                      </span>
                    :<></>  
                  }
                  </Table.Cell>
      ...
      <Pagination
        ...
        {allowAdd
        ? <div> 
          <Link  to={'/ProjectAVEDTabsAdd'}>Add New Project</Link>
          </div>
        :<></>
        }
  ...
  export default ProjectsTableListSemUI;